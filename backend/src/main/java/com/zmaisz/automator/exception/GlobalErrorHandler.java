...
public class GlobalErrorHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> handleUserGroupAlreadyExistsException(UserGroupAlreadyExistsException ex,
            WebRequest request) {
        ErrorResponseDTO errorResponse = new ErrorResponseDTO(
                LocalDateTime.now(),
                ex.getMessage());
    ...
    public ResponseEntity<ErrorResponseDTO> handleTokenNotFoundException(TokenNotFoundException ex, WebRequest request) {
        ErrorResponseDTO errorResponse = new ErrorResponseDTO(
                LocalDateTime.now(),
                ex.getMessage());
        return new ResponseEntity<>(errorResponse, HttpStatus.UNAUTHORIZED);
